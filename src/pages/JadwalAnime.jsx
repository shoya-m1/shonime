        ...
        {loading ? (
          ...
          <>
            <section className="mt-7 flex gap-3 w-full justify-center border-b-1 pb-6 border-neutral-600 flex-wrap">
              {animes?.map((data, i) => (
                <Link className="border border-neutral-600 hover:bg-yellow-500 cursor-pointer duration-200 py-1 px-7" key={i} to={data.day} smooth={true} spy={true} offset={-200} duration={1000}>
                  {data.day}
                </Link>
              ))}
            </section>
