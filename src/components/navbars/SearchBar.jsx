...
export const SearchBar = ({ showSearch }) => {
  ...
  return (
    <div className={`${showSearch ? "translate-y-0 z-5" : "-z-10 translate-y-[-60px]"} duration-300 ese-in-out absolute md:static md:opacity-100 pe-10 md:pe-0 w-full md:w-auto lg:w-xs space-y-3 my-2 md:ms-3 lg:ms-10 mx-5 md:mx-2 mt-1 pt-5 md:pt-1 md:mt-1`}>
